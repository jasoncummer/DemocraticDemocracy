...
When the law is over that threshold, some threshold that will give it a level of stability, it will be added to the next "update" of enforceable laws.

The laws have dynamic elements that will be calculated every x# of minutes to adjust the law. 

The laws can therefore be altered by the people any time and be best suited to the people at the time.

If the law becomes outdated users could petition to have it removed, if it gets voted out, its removed from the enforceable laws.



Warning:
Overly influential people or news networks may temporaly influence the laws. 
  This might be attenuated by adding different calculations times or voter number thresholds. 
...
Laws can be updated to reflect the values of the people they serve in the current context.
